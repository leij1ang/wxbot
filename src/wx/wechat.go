...
func (self *WxWeb) _init() {
	...
	self.deviceId = "erobot"
}

func (self *WxWeb) getUuid(args ...interface{}) bool {
	urlstr := "https://login.web.wechat.com/jslogin?"
	urlstr += "appid=" + utils.Conf.HttpConf.Token +
		"&redirect_uri=https%3A%2F%2Fweb.wechat.com%2Fcgi-bin%2Fmmwebwx-bin%2Fwebwxnewloginpage&fun=new&lang=zh_CN&_=" + self._unixStr()
	utils.Log("debug",urlstr)
